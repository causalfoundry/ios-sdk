...
public struct PatientStatusItem: Codable {
    ...
    public init(type: String, value: String, diagnosisYear: String? = "", diagnosisType: String? = "", isConfirmed: Bool? = nil, remarks: String? = nil) {
        self.type = type
        self.value = value
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(diagnosisYear, forKey: .diagnosisYear)
