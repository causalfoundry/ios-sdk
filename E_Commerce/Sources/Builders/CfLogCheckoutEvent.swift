...
class CfLogCheckoutEvent {
   ...
   @discardableResult
    public func  setPrice(price: Float) -> CfLogCheckoutEvent {
        self.price_value = ((price * 100.0).rounded() / 100.0)
        return self
    }
    
   @discardableResult
    public func  setPrice(price: Int?) -> CfLogCheckoutEvent {
        self.price_value = price != nil ? Float(price!) : nil
        return self
    }
    
   @discardableResult
    public func setPrice(price: Double) -> CfLogCheckoutEvent {
        self.price_value = Float((price * 100.0).rounded() / 100.0)
        return self
    }
   ...
   @discardableResult
    public func  setShopMode(shopMode: ShopMode) -> CfLogCheckoutEvent {
        self.shop_mode = shopMode.rawValue
        return self
    }
   ...
   @discardableResult
    public func addItem(itemModel: ItemModel) -> CfLogCheckoutEvent {
        ...
        self.item_list.append(itemModel)
        return self
    }
   ...
   @discardableResult
    public func addItemList(itemList: [ItemModel]) -> CfLogCheckoutEvent {
        ...
        self.item_list.append(contentsOf: itemList)
        return self
    }
