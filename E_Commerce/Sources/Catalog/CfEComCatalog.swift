...
public class CfEComCatalog {
    public static func callCatalogAPI(itemId: String, itemType: String, catalogModel: Any) {
        ...
        // Grocery Catalog
        public func updateGroceryCatalog(itemId: String, groceryCatalogModel: String) {
        ...
        public func updateGroceryCatalog(itemId: String, groceryCatalogModel: GroceryCatalogModel) {
        ...
        // Blood Catalog
        public func updateBloodCatalog(itemId: String, bloodCatalogModel: String) {
        ...
        public func updateBloodCatalog(itemId: String, bloodCatalogModel: BloodCatalogModel) {
        ...
        // Oxygen Catalog
        public func updateOxygenCatalog(itemId: String, oxygenCatalogModel: String) {
        ...
        public func updateOxygenCatalog(itemId: String, oxygenCatalogModel: OxygenCatalogModel) {
        ...
        public func updateMedicalEquipmentCatalog(itemId: String, medicalEquipmentCatalogModel: String) {
        ...
        public func updateMedicalEquipmentCatalog(itemId: String, medicalEquipmentCatalogModel: MedicalEquipmentCatalogModel) {
        ...
        // Facility Catalogd
        public func updateFacilityCatalog(facilityId: String, facilityCatalogModel: String) {
        ...
        public func updateFacilityCatalog(facilityId: String, facilityCatalogModel: FacilityCatalogModel) {
