...
struct InternalMedicalEquipmentCatalogModel: Codable {
    ...
    public init(id: String, name: String, description: String? = "", marketId: String? = "", supplierId: String? = "", supplierName: String? = "", producer: String? = "", packaging: String? = "", packagingSize: Float? = 0, packagingUnits: String? = "", category: String? = "") {
        self.id = id
        self.name = name
