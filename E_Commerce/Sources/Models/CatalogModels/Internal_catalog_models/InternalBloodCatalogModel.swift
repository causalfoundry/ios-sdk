...
struct InternalBloodCatalogModel: Codable {
    ...
    public init(id: String, bloodGroup: String, marketId: String? = "", bloodComponent: String? = "", packaging: String? = "", packagingSize: Float? = 0, packagingUnits: String? = "", supplierId: String? = "", supplierName: String? = "") {
        self.id = id
